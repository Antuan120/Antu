...
public class GUIManual extends JFrame {
   ...
   /* private void accionAuditoria() {
        ...
        AuditoriaDAO auditoriaa = new AuditoriaDAO();
        JTextArea Auditoria = new JTextArea();
jPanelMain.setBackground(Color.white);
        JPanel panelSelecciones = new JPanel();
        JLabel totalSelecciones = new JLabel("<html><div style='text-align: center; font-size: 15pt;'><span style='font-size: 45;'>AUDITORIA</div></html>");
        panelSelecciones.add(totalSelecciones);
        panelSelecciones.setBackground(Color.white);
        panelSelecciones.setPreferredSize(new Dimension(600, 600));
         totalSelecciones.setHorizontalAlignment(JLabel.CENTER);
        totalSelecciones.setFont(new Font("Verdana", Font.BOLD, 13));
        totalSelecciones.setForeground(Color.BLACK);
        auditoriaa.ingresarClick(home, dashSelecciones, dashResultados, seleccione, resultado);
        home=0;
        dashSelecciones=0;
        dashResultados=0;
        seleccione=0;
        ...
        table.setModel(auditoriaa.tablaAuditoria());
        table.setPreferredSize(new Dimension(600,600));
        panelSelecciones.add(table);
        jPanelMain.removeAll();
        jPanelMain.add(Auditoria);
    ...
    private void accionDashboardSel() {
        ...
        JPanel panelSelecciones = new JPanel();
        JLabel totalSelecciones = new JLabel("<html><div style='text-align: center; font-size: 15pt;'><span style='font-size: 45;'>" + seleccionDAO.totalPartidos() + "</span><br>Seleciones Cargadas</div></html>");
        panelSelecciones.add(totalSelecciones);
        panelSelecciones.setBackground(Color.gray);
        panelSelecciones.setPreferredSize(new Dimension(200, 100));
        totalSelecciones.setHorizontalAlignment(JLabel.CENTER);
        totalSelecciones.setFont(new Font("Verdana", Font.BOLD, 13));
        totalSelecciones.setForeground(Color.BLACK);
